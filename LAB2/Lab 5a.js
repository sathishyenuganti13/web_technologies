...
let str = new String("Hello, My Name is sathish.");
...
Output.innerHTML += "8. Ends with 'sathish.': " + str.endsWith("sathish.") + "<br>";

Output.innerHTML += "9. Index of 'sathish': " + str.indexOf("sathish") + "<br>";
